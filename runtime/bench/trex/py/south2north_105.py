...
bind_layers(UDP, VXLAN, dport=4788)
...
def get_vxlan_ssdp_pkt( vxlan_smac_x, vxlan_dmac_x, vxlan_sip_x, vxlan_dip_x, vxlan_sport_x, vxlan_vni_x, guest_vlan_x, guest_prio_x, guest_sip_x, guest_dip_x, guest_sport_x ):
	vxlan_ssdp_pkt = get_scapy_vxlan_udp_pkt( vxlan_smac_x, vxlan_dmac_x, vxlan_sip_x, vxlan_dip_x, vxlan_sport_x, 4788, vxlan_vni_x, guest_vlan_x, guest_prio_x, guest_sip_x, guest_dip_x, guest_sport_x, 1900, ssdp_payload_raw )
...
class STLS1(object):
	...
	def create_stream (self):
		...
		for class_c_vtep_x in range(0, vxlan_vnis_count):
			...
			if stream_id == 0:
				##########################################
				vxlan_sip_x = "10.107.107.107"
				##########################################
				vtep_dip_min =                       240
				vtep_dip_min = (vtep_dip_min << 8) + 7
				vtep_dip_min = (vtep_dip_min << 8) + 7
				vtep_dip_min = (vtep_dip_min << 8) + 6
				##########################################
			elif stream_id == 1:
				##########################################
				vxlan_sip_x = "10.117.117.117"
				##########################################
				vtep_dip_min =                       240
				vtep_dip_min = (vtep_dip_min << 8) + 17
				vtep_dip_min = (vtep_dip_min << 8) + 17
				vtep_dip_min = (vtep_dip_min << 8) + 15
				##########################################
			elif stream_id == 2:
				##########################################
				vxlan_sip_x = "10.127.127.127"
				##########################################
				vtep_dip_min =                       240
				vtep_dip_min = (vtep_dip_min << 8) + 27
				vtep_dip_min = (vtep_dip_min << 8) + 27
				vtep_dip_min = (vtep_dip_min << 8) + 24
				##########################################
			else:
				##########################################
				vxlan_sip_x = "10.137.137.137"
				##########################################
				vtep_dip_min =                       240
				vtep_dip_min = (vtep_dip_min << 8) + 37
				vtep_dip_min = (vtep_dip_min << 8) + 37
				vtep_dip_min = (vtep_dip_min << 8) + 33
				##########################################
			...
			for guest_vlan_x in range(guest_vlan_min, guest_vlan_max):
				for guest_prio_x in range(guest_prio_min, guest_prio_max):
					...
					vxlan_smac_x = '08:00:27:2d:f1:14'
